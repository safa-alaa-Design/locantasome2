...
function addToCartClicked(event) {
    ...
    var currency = shopItem.getElementsByClassName('shop-item-currency')[0].innerText
    var imageSrc = shopItem.getElementsByClassName('shop-item-image')[0].src
    var watsapp = shopItem.getElementsByClassName('shop-item-tel')[0].innerText

    addItemToCart(imageSrc, price, watsapp, name, currency, category)
    updateCartTotal()
...
function addItemToCart(imageSrc, price,watsapp, name, currency ,category) {
    ...
    var cartRowContents = `
                ...
                <span class="cart-price"> ${price}<span class="cart-currency">${currency}</span></span>
