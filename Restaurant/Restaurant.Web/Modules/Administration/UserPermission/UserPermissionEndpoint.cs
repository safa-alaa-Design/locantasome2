using MyRepository = Restaurant.Administration.Repositories.UserPermissionRepository;
using MyRow = Restaurant.Administration.UserPermissionRow;

namespace Restaurant.Administration.Endpoints;
