...
namespace Restaurant.Texts {
    ...
    export declare namespace Db {
        ...
        namespace Default {
            ...
            namespace CategoryMeals {
                export const CategoryMealsName: string;
                export const Description: string;
                export const Id: string;
                export const Photo: string;
            }
            ...
            namespace Item {
                ...
                export const MealsId: string;
                export const MealsName: string;
                export const Photo: string;
            }

            namespace Meals {
                export const CategoryMealsId: string;
                export const CategoryMealsName: string;
                ...
                export const PriceBefor: string;
            }
    ...
    Restaurant['Texts'] = proxyTexts(Texts, '', {
        Db: {
            Administration: {
                Language: {},
                Role: {},
...
export const Texts = Restaurant.Texts;